...
|-----------|----------|----------|
| Architecture, scoping, decisions | Ripley 🏗️ | Feature decomposition, design review, cross-cutting concerns |
| XAML controls, UI layout, animations | Dallas ⚛️ | New controls, styling, visual polish, resource dictionaries |
| Action system, tab/pane plumbing, IDL | Parker 🔧 | New actions, dispatch wiring, state management, WinRT interfaces |
| Code review | Ripley 🏗️ | Review PRs, check quality, enforce patterns |
